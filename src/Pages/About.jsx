    ...
    return (
        <div className='my-12  flex gap-6 flex-col justify-center items-center text-center'>
            <div className='space-y-2 w-4/5'>
               ...
               <p className='text-gray-800'>Eco Adventure is an exciting journey into the heart of nature, designed to combine outdoor thrills with a commitment to environmental stewardship. This adventure offers participants the chance to explore pristine landscapes, engage in activities like hiking, kayaking, and wildlife observation, all while learning about conservation efforts and sustainable practices. Ideal for eco-conscious travelers and nature lovers, Eco Adventure aims to leave minimal impact on the environment.</p>
            </div>
